...
class UsersSignupTest < ActionDispatch::IntegrationTest
 ...
 def setup
    ...
    @user.profile = @profile = Profile.new(name: "Example Test", street: "24 Fred Rd", city: "Cutlin", state: "SW", zipcode: "35478")
 end
 ...
 test "valid signup information" do
    ...
    assert_difference 'User.count', 1 do
      ...
      post users_path(user), params: { user: user.attributes }
            ###  debugger
      
      get user_profile_path(user), params: { user: user}
      assert user_profile_path(user)
    end
